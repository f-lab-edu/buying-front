    ...
    <div v-if="!isLoading && post" class="post-detail">
      <div class="hero">
        ...
        <div class="hero-actions">
          ...
          <div class="hero-right">
            ...
            <button class="icon-button" @click="sharePost" aria-label="공유하기">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
            ...
            <button class="icon-button" @click="moreOptions" aria-label="더보기">
      ...
      <section class="seller-section">
        <div class="seller-profile">
          ...
          <div>
            <p class="seller-name">{{ post.member?.nickname || '알 수 없음' }}</p>
      ...
      <section class="post-body">
        ...
        <p v-if="displayQuantity" class="post-quantity">수량 {{ displayQuantity }}개</p>
      ...
      <footer class="action-bar">
        <button class="wish-button" aria-label="관심 등록">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
            <path d="M20.8 4.6a5.5 5.5 0 0 0-7.8 0L12 5.6l-1-1a5.5 5.5 0 1 0-7.8 7.8l1 1L12 21.3l7.8-7.9 1-1a5.5 5.5 0 0 0 0-7.8z" />
          </svg>
        </button>
        <button class="secondary-button" @click="handlePay">결제하기</button>
        <button class="primary-button" @click="handleChat">채팅하기</button>
      </footer>
    </div>
  ...
  setup() {
    ...
    const loadPost = async () => {
      ...
      try {
        ...
        post.value = data
        const rawImages = Array.isArray(data?.images) && data.images.length ? data.images : [PLACEHOLDER_IMAGE]
    ...
    const currentImage = computed(() => images.value[currentIndex.value] || PLACEHOLDER_IMAGE)
