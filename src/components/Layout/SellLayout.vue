<template>
  <div class="post-create-page">
    <header class="top-bar">
      ...
      <button class="link-button" type="button" @click="handleDraft">임시저장</button>
    </header>
    ...
    <main class="content-area">
      <section class="image-section">
        ...
        <div class="image-list">
          ...
          >
            ...
            <button class="delete-button" type="button" @click="removeImage(index)" aria-label="삭제">
      ...
      <section class="form-section">
        ...
        <div class="form-group">
          ...
          />
          <button class="secondary-button" type="button" @click="handlePhrase">자주 쓰는 문구</button>
        </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group quantity-group">
            ...
            <div class="quantity-control">
              <button type="button" @click="decrementQuantity" :disabled="form.quantity <= 1">-</button>
